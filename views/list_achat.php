                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>Unite</th>
                          <th>Quantite</th>
                          <th style="width: 10%;">P.A.U</th>
                          <th style="width: 10%;">P.A.T</th>
                          <th style="width: 10%;">P.V.U Min</th>
                          <th style="width: 10%;">P.V.U Max</th>
                        </tr>
                      </thead>
                      <tbody>
<?php $all=$db->getRows('ab_achats', array('order_by'=>'id desc'));
      ...
      ?>
                        <tr>
                          ...
                          <td><?php echo $show['quantity_achat'] ?></td>
                          <td><?php echo $show['pau'] ?> $</td>
                          <td><?php echo $show['pat'] ?> $</td>
