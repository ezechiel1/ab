                ...
                <div class="x_panel">
                  <div class="x_content">
                    <div class="row">
                      ...
                      <div class="clearfix"></div>
<?php
$all = $db->getRows('ab_users', array('order_by'=>'fname asc', 'where'=>array('category_id'=>3))); if(!empty($all)): $count=0; foreach($all as $show): $count++;
 ?>
                        ...
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            ...
                            <div class="left col-xs-7">
                              ...
                              <p><strong>Position: </strong> Employe </p>
